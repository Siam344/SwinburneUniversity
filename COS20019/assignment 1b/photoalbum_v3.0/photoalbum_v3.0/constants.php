...
define('TUTORIAL_SESSION', 'Thursday 6:30PM');

// [ACTION REQUIRED] name of the S3 bucket that stores images
define('BUCKET_NAME', 'nesaim-s3-photo-bucket');
...
define('DB_ENDPOINT', 'rds-instance.cfg1su8spy97.us-east-1.rds.amazonaws.com');
...
define('DB_PHOTO_S3REFERENCE_COL_NAME', 'Reference_To_Photos_In_s3');
?>