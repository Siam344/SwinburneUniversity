<template>
    <section class="videos">
      <div class="container">
        <h2>Latest Videos</h2>
        <article class="video-item" v-for="(video, index) in videos" :key="index">
          <video controls :src="video.src" :poster="video.poster"></video>
        ...
        videos: [
          {
            ...
            poster: require('../assets/images/video1.jpg')
          },
          {
            title: 'Video Title 2',
            description: 'Description for video 2...',
            src: require('../assets/videos/video2.mp4'),
            poster: require('../assets/images/video2.jpg')
          },
          {
            title: 'Video Title 3',
            description: 'Description for video 3...',
            src: require('../assets/videos/video3.mp4'),
            poster: require('../assets/images/video3.jpg')
          }
        ]
      }
    }
  ...
  <style scoped>
  /* Add videos-specific styles here */
